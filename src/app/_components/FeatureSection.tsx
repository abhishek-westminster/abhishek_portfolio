export default function FeatureSection() {
  return (
    <>
      <div className="w-full bg-background px-4 py-8 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto flex max-w-3xl flex-col justify-center gap-2 text-center sm:gap-4">
            ...
            <p className="text-base leading-7 text-muted-foreground transition-all sm:text-lg sm:leading-8">
